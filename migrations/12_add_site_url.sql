-- =============================================================================
--  MIGRATION 12: Add site_url to site_settings
--  =============================================================================
--  Stores the production site URL so email links and integrations always
--  point to the correct domain, regardless of build-time env vars.
-- =============================================================================

alter table public.site_settings
  add column if not exists site_url text;

-- Seed with the production domain if currently null
update public.site_settings
  set site_url = 'https://shahdmall.com'
